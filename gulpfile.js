  ...
  () =>
    gulp
      .src([
        ...
        "./src/js/jquery.barrating.min.js"
      ])
      // .pipe(plumber())
      // .pipe(
      //   babel({
...
gulp.task("fonts", () =>
  gulp
    .src(["./src/fonts/**/*.{woff,woff2,ttf}", "./src/libs/slick/fonts/**/*.{woff,woff2,ttf}"])
...
gulp.task("build", cb =>
  sequence("del:build", "svg-sprite", "fonts", "styles", "styles2", "styles3", "html", "scripts", "images", cb)
);
